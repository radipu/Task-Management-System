		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$stat = array("Pending","Running","Running","On-Hold","Over Due","Pause");
					...
					<tr>
						...
						<td class="text-center">
							<?php
							  ...
							  }elseif($stat[$row['pstatus']] =='Running'){
						...
						<td>
                        	...
                        	if($row['status'] == 1){
						  		...
						  		echo "<span class='badge badge-warning'>Pause</span>";
                        	}
                        	?>
                        </td>
						<td class="text-center">
