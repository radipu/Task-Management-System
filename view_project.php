...
$stat = array("Pending","Running","On-Hold","Over Due","Pause");
								...
								<tr>
			                        ...
			                        <td>
			                        	...
			                        	if($row['status'] == 1){
									  		...
									  		echo "<span class='badge badge-primary'>Running</span>";
			                        	}elseif($row['status'] == 3){
									  		echo "<span class='badge badge-success'>Pause</span>";
			                        	}
			                        	?>
			                        </td>
			                        <td><b><?php echo $row['note'] ?></b></td>
									<td><b><?php echo ucwords($manager['name']) ?></b></td>
