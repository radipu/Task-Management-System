          	...
          	<div class="col-md-6">
				<div class="form-group">
					...
					<select name="status" id="status" class="custom-select custom-select-sm">
						<option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Running</option>
						<option value="3" <?php echo isset($status) && $status == 3 ? 'selected' : '' ?>>Pending</option>
						<option value="5" <?php echo isset($status) && $status == 5 ? 'selected' : '' ?>>Pause</option>
					</select>
				</div>
			</div>
		</div>
